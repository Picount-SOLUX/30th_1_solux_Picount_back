...
@Getter
@AllArgsConstructor
public class MyCalendarDesignResponseDto {
    private Long itemId;
    private String name;
    private String previewImageUrl;
    private String skinImageUrl;

    public static MyCalendarDesignResponseDto from(Item item, Sticker sticker) {
        return new MyCalendarDesignResponseDto(
                item.getItemId(),
                item.getName(),
